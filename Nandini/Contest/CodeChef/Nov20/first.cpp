...
//   }  
//   //cout << "ind=" << ind << endl;
//   int maxi2 =-1e9,ind2=0;
//   for(int i=0 ; i<n ;i ++)
//   {
//      if(i!=ind && maxi2<v[i].f)
//      {
//       //  maxi2 = v[i].f;
//         ind2 = i;
//      }
//   }    
//   //cout << "ind=" << ind2 << endl;
//   maxi2 = max(v[ind2].f,v[ind2].s);
//   //cout << "Maxi=" << maxi << ",maxi2=" << maxi2 << endl; 
//   if(maxi > maxi2) cout << "Yes" << endl;
//   else cout << "No" << endl; 
...
void solve() 
{
  ...
  int maxi = -1,maxi2=-1,ind2=-1,ind = -1;
  for(int i=0 ; i<n ; i++)
  {
    if(maxi<v[i].f){
        maxi = v[i].f;
  ...
  for(int i=0 ; i<n ; i++)
  {
    if(maxi2<v[i].f && i!=ind){
        maxi2 = v[i].f;
        ind2 = i;
    }
  }      

  int bob =max(v[ind].f,v[ind].s); 
  int bob2 = max(v[ind2].f,v[ind2].s);
  maxi = -1; 
  for(int i=0 ; i<n ;i ++)
  {
     if(i!=ind){
